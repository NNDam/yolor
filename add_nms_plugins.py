...
if __name__ == '__main__':
    ...
    model.eval()
    sample_output  = torch.rand(size = (1, 128520, 85))
    ...
    torch.onnx.export(model,               # model being run
                      ...
                      "yolor_post_process.onnx",   # where to save the model (can be a file or file-like object)
    ...
    model2 = onnx.load('yolor_post_process.onnx')
    ...
    onnx.save(gs.export_onnx(graph), "yolor_csp_x_star-nms.onnx")
